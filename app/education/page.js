...
const features = [
  {
    title: "Audience Comprehension",
    description: "We go deep into your target audience demographics to create content that resonates and engages.",
    image: "/bfsiexpertise.jpg",
    alt: "Audience Comprehension",
  },
  {
    title: "SEO Considerations",
    description: "We create content to rank and create organic traffic and visibility.",
    image: "/seooptbfsi.jpg",
    alt: "SEO Considerations",
  },
  {
    title: "Performance Metrics",
    description: "We constantly monitor content performance and refine strategies for optimal ROI.",
  ...
  const metrics = [
    ...
    {
      value: '1M+',
      description: 'Over 1 million pieces of creative content delivered, proving we can meet projects of all scales.'
    },
    {
      value: '600+',
      description: 'Interactions with over 600 global clients, demonstrating our flexibility and expertise.'
    }
  ];
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:justify-center border-4 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[25vh] md:h-[45vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full mt-4 py-8 md:py-4 relative overflow-visible">
          ...
          >
            ...
            >
              Education & EdTech Content <span className='text-[#4B7D57]'><br/>That Educates and Engages</span>
            </motion.h1>    
          </motion.div>
      ...
      <div className="flex justify-center md:mt-22 mt-12 px-4 md:px-6">
        <p className="text-center max-w-4xl mx-auto text-[#6a6a6a]">In the fast-changing world of education and EdTech, it is essential to communicate clear, engaging, and valuable information. At TransCurators, we create content that informs and inspires all learners, educators, and other stakeholders.</p>
      </div>
        ...
        <div className="max-w-screen-xl flex justify-center mx-auto items-center">
          <div className="text-center flex-row">
            <p className="md:text-3xl text-xl text-black font-medium mt-4">
              ...
              <span className="text-[#326B3F]"><br/>Education & EdTech Content?</span>
            </p>
            <p className="text-sm text-[#6a6a6a] mt-4 ">
              At TransCurators, we have over 200+ specialist writers and understand the nuances of educational content. Our content strategies draw from:
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 w-[45vw] h-[45vw] md:w-[32vw] md:h-[32vw] lg:w-[29vw] lg:h-[29vw] rounded-[50%] bg-[#7db88b]/60 -translate-y-[40%]"></div>
            ...
            <div className="flex flex-col md:flex-row border-2 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[50vh] md:h-[90vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full md:mt-22 mt-12 py-8 md:py-4 relative overflow-hidden">
              ...
              >
                ...
                >
                  We have worked with many clients on e-learning platforms, colleges, and universities and feel confident creating best-in-class deliverables. Our services include:
                </motion.h2>
                  ...
                  {[
  {
    ...
    description: "Develop, organize, and create engaging and interactive course content."
  },
  {
    number: 2,
    title: "Blogs & Articles",
    description: "Providing articles about current issues, trends, and best practices in education."
  },
  {
    number: 3,
    title: "Whitepapers & Case Studies",
    description: "Provide evidence through your research and success stories to build credibility."
  },
  {
    number: 4,
    title: "Social Media Campaigns",
    description: "Writing community and brand nurturing, engaging posts for social theatre."
  },
  {
    number: 5,
    title: "Email Marketing",
    description: "Creating and designing newsletters that inform, engage, and deliver a return on investment."
  }
].map((item, index) => (
                    <motion.div
                      key={item.number}
              ...
              <div className="relative bg-[#D9E9DD] w-full">
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
                  ...
                  <p className="text-[#6a6a6a] text-sm md:text-base text-center px-2 md:px-4 max-w-4xl mx-auto leading-relaxed mb-8">
                    Whether you are developing a new e-learning platform, marketing an education-related asset, or looking for greater student engagement, our content strategies cover your basic needs. We approach our work through three strategies of content development:
                  </p>
                    ...
                    {[
                      {
                        ...
                        description: "Maintain consistency for all content channels."
                      },
                      {
                        title: "Aligning with Your Educational Goals",
                        description: "Ensure that each piece of content aligns with your goals."
                      },
                      {
                        title: "Creating Engagement",
                        description: "Produce content that engages and retains the reader."
                      }
                    ].map((step, idx) => (
                      <div
                        key={idx}
      ...
      <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
        ...
        <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-12 max-w-xl w-full md:mr-[-96px] z-10">
          <h2 className="text-2xl md:text-3xl mb-4">
            Let's Elevate Your<span className='text-[#326B3F]'><br/>Educational Content Together</span>
          </h2>
          <p className="text-[#6a6a6a] mb-4">
            With all the noise surrounding education and EdTech, unique content can be your edge in the market. At TransCurators, we are excited to partner with you to create informative, engaging stories that inspire action.
          </p>
        </div>
        ...
        <div className="hidden md:flex mt-8 md:mt-0 md:ml-[-64px] flex-1 items-center justify-center">
          <div className="rounded-2xl overflow-hidden w-[859px] h-[476px] flex items-center justify-center shadow-lg">
            <Image
              src="/bfsiending.jpg"
              alt="Education & EdTech Content Image"
              width={900}
              height={900}
      ...
      <section className="w-full flex justify-center mt-8 mb-8 px-2">
        <div className="w-full max-w-6xl bg-[#D9E9DD] rounded-[2.5rem] px-6 py-12 md:px-16 md:py-16 text-center">
          <h2 className="text-2xl md:text-3xl font-medium mb-6 font-sans">
            Would you like to elevate your <span className="text-[#326B3F]">educational content strategy?</span>
          </h2>
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-sans">
            Contact us today, and let's start taking your brand to new heights in education and EdTech.
          </p>
        </div>
      </section>
