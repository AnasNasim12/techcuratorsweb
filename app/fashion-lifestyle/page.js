...
const features = [
  {
    ...
    description: "Understanding your audience so the content will resonate and engage with your target demographics.",
    image: "/bfsiexpertise.jpg",
    alt: "Audience Understanding",
  },
  {
    title: "SEO Optimization",
    description: "Writing content that was made to rank on search engines so we can produce organic traffic on search and other platforms.",
    image: "/seooptbfsi.jpg",
    alt: "SEO Optimization",
  },
  {
    title: "Performance Tracking",
    description: "Monitor and track performance so we can adjust on the fly and keep maximizing our ROI from content at all times.",
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:justify-center border-4 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[25vh] md:h-[45vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full mt-4 py-8 md:py-4 relative overflow-visible">
          ...
          >
            ...
            >
              Fashion & Lifestyle Content <span className='text-[#4B7D57]'><br/>That Defines Trends</span>
            </motion.h1>    
          </motion.div>
      ...
      <div className="flex justify-center md:mt-22 mt-12 px-4 md:px-6">
        <p className="text-center max-w-4xl mx-auto text-[#6a6a6a]">In the constantly changing landscape of fashion and lifestyle, changing fashions, styles and consumer preferences can come quickly, and strong content is key to capturing and retaining your audience. At TransCurators, we tell stories with style while integrating your brand's ethos.</p>
      </div>
        ...
        <div className="max-w-screen-xl flex justify-center mx-auto items-center">
          <div className="text-center flex-row">
            <p className="md:text-3xl text-xl text-black font-medium mt-4">
              ...
              <span className="text-[#326B3F]"><br/>Fashion & Lifestyle Content?</span>
            </p>
            <p className="text-sm text-[#6a6a6a] mt-4 ">
              We have a group of writers of over 200+ unique and specialized writers who understand the sectors of fashion and lifestyle writing. Our content plans are built on:
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 w-[45vw] h-[45vw] md:w-[32vw] md:h-[32vw] lg:w-[29vw] lg:h-[29vw] rounded-[50%] bg-[#7db88b]/60 -translate-y-[40%]"></div>
            ...
            <div className="flex flex-col md:flex-row border-2 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[50vh] md:h-[90vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full md:mt-22 mt-12 py-8 md:py-4 relative overflow-hidden">
              ...
              >
                ...
                >
                  We've developed a knack for a good story after working with various clients, from young fashion designers to established lifestyle brands. Our services include:
                </motion.h2>
                  ...
                  {[
  {
    ...
    description: "We highlight features and benefits to compel potential customers."
  },
  {
    number: 2,
    title: "Fashion Blogs & Articles",
    description: "Trendy insights, looks and styling tips, industry happenings."
  },
  {
    number: 3,
    title: "Social Media Campaigns",
    description: "Creating posts to stimulate community and brand love."
  },
  {
    number: 4,
    title: "Email Marketing",
    description: "Delivering newsletters that inform & invite, engage & convert."
  },
  {
    number: 5,
    title: "Video Scripts",
    description: "We provide marches and narratives for promotional and tutorial videos."
  }
].map((item, index) => (
                    <motion.div
                      key={item.number}
          ...
          <section id="metrics-section" className="md:mt-22 mt-12 bg-white">
              <div className="max-w-screen-xl mx-auto px-4">
                  <div className="text-center mb-8 md:mb-16">
                      ...
                      <p className="text-[#6a6a6a] mt-4 text-sm">Our track record reflects our dedication to excellence:</p>
                  </div>
              ...
              <div className="relative bg-[#D9E9DD] w-full">
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
                  ...
                  <p className="text-[#6a6a6a] text-sm md:text-base text-center px-2 md:px-4 max-w-4xl mx-auto leading-relaxed mb-8">
                    If you are launching a new clothing line, promoting lifestyle products or just looking to raise brand awareness, our content strategies are tailored to your specific goals. We concentrate on:
                  </p>
                  <div className="flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6 max-w-5xl mx-auto">
                    {[
                      {
                        title: "Identifying Your Brand Voice",
                        description: "Ensuring consistency across all content platforms."
                      },
                      {
                        title: "Aligning to Your Strategic Marketing Objectives",
                        description: "Creating content that fits your broader marketing strategy."
                      },
                      {
                        title: "Encouraging Engagement",
                        description: "Creating content that draws an audience in and keeps them engaged."
                      }
                    ].map((step, idx) => (
                      <div
                        key={idx}
      ...
      <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
        ...
        <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-12 max-w-xl w-full md:mr-[-96px] z-10">
          ...
          <p className="text-[#6a6a6a] mb-4">
            In the competitive world of fashion and lifestyle, compelling content can be your differentiator. At TransCurators, we're ready to partner with you to create narratives that not only inform but also inspire.
          </p>
        </div>
        ...
        <div className="hidden md:flex mt-8 md:mt-0 md:ml-[-64px] flex-1 items-center justify-center">
          <div className="rounded-2xl overflow-hidden w-[859px] h-[476px] flex items-center justify-center shadow-lg">
            <Image
              src="/fashionlifestyle.jpg"
              alt="Fashion & Lifestyle Content Image"
              width={900}
              height={900}
      ...
      <section className="w-full flex justify-center mt-8 mb-8 px-2">
        <div className="w-full max-w-6xl bg-[#D9E9DD] rounded-[2.5rem] px-6 py-12 md:px-16 md:py-16 text-center">
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-sans">
            Contact us today and let's embark on a journey to elevate your brand's presence in the fashion and lifestyle landscape.
          </p>
        </div>
      </section>
...
export default FashionLifestylePage;
