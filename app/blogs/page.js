      ...
      >
        ...
        >
          <motion.div 
            ...
            className="inline-block px-4 py-1 bg-[#326B3F]/20 rounded-full mb-6"
            whileHover={{ scale: 1.05 }}
            transition={{ type: "spring", stiffness: 400, damping: 10 }}
          >
            <span className="text-[#326B3F] font-medium text-sm">Our Blog</span>
          </motion.div>
        ...
        <div className="max-w-screen-xl mx-auto px-4 text-center">
          ...
          >
            <motion.button 
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto px-6 py-3 bg-[#326B3F] text-white rounded-md shadow-md hover:shadow-lg transition-all duration-300"
            >
              Subscribe
            </motion.button>
          </motion.div>
