...
const features = [
  {
    ...
    description: "Delving deep into your target demographics to ensure content resonates and engages.",
    image: "/bfsiexpertise.jpg",
    alt: "Audience Understanding",
  },
  {
    title: "SEO Optimization",
    description: "Crafting content designed to rank, driving organic traffic and enhancing visibility.",
    image: "/seooptbfsi.jpg",
    alt: "SEO Optimization",
  },
  {
    title: "Performance Tracking",
    description: "Continuously monitoring content performance, refining strategies for optimal ROI.",
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:justify-center border-4 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[25vh] md:h-[45vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full mt-4 py-8 md:py-4 relative overflow-visible">
          ...
          >
            ...
            >
              Entertainment & Gaming Content <span className='text-[#4B7D57]'><br/>That Captivates and Converts</span>
            </motion.h1>    
          </motion.div>
      ...
      <div className="flex justify-center md:mt-22 mt-12 px-4 md:px-6">
        <p className="text-center max-w-4xl mx-auto text-[#6a6a6a]">In the vibrant worlds of entertainment and gaming, where storytelling meets interactivity, compelling content is the key to capturing and retaining audience attention. At TransCurators, we specialize in crafting narratives that not only engage but also drive meaningful connections with your audience.</p>
      </div>
        ...
        <div className="max-w-screen-xl flex justify-center mx-auto items-center">
          <div className="text-center flex-row">
            <p className="md:text-3xl text-xl text-black font-medium mt-4">
              ...
              <span className="text-[#326B3F]"><br/>Entertainment & Gaming Content?</span>
            </p>
            <p className="text-sm text-[#6a6a6a] mt-4 ">
              With a team of over 200+ specialized writers, we understand the nuances of the entertainment and gaming industries. Our content strategies are rooted in:
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 w-[45vw] h-[45vw] md:w-[32vw] md:h-[32vw] lg:w-[29vw] lg:h-[29vw] rounded-[50%] bg-[#7db88b]/60 -translate-y-[40%]"></div>
            ...
            <div className="flex flex-col md:flex-row border-2 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[50vh] md:h-[90vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full md:mt-22 mt-12 py-8 md:py-4 relative overflow-hidden">
              ...
              >
                ...
                >
                  Having collaborated with a diverse clientele, from indie game developers to major entertainment studios, we've honed our skills to deliver content that stands out. Our services encompass:
                </motion.h2>
                  ...
                  {[
  {
    ...
    description: "Highlighting features and gameplay to entice potential players."
  },
  {
    number: 2,
    title: "Entertainment News & Blogs",
    description: "Covering the latest trends, releases, and industry insights."
  },
  {
    number: 3,
  ...
  },
  {
    number: 4,
    title: "Video Scripts",
    description: "Producing compelling narratives for trailers, promotional videos, and more."
  },
  {
    number: 5,
              ...
              <div className="relative bg-[#D9E9DD] w-full">
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
                  ...
                  <p className="text-[#6a6a6a] text-sm md:text-base text-center px-2 md:px-4 max-w-4xl mx-auto leading-relaxed mb-8">
                    Whether you're launching a new game, promoting a film, or aiming to increase audience engagement, our content strategies are customized to meet your specific objectives. We focus on:
                  </p>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
        ...
        <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-12 max-w-xl w-full md:mr-[-96px] z-10">
          ...
          <p className="text-[#6a6a6a] mb-4">
            In the competitive world of entertainment and gaming, compelling content can be your differentiator. At TransCurators, we're ready to partner with you to create narratives that not only inform but also inspire.
          </p>
        </div>
        ...
        <div className="hidden md:flex mt-8 md:mt-0 md:ml-[-64px] flex-1 items-center justify-center">
          <div className="rounded-2xl overflow-hidden w-[859px] h-[476px] flex items-center justify-center shadow-lg">
            <Image
              src="/entgaming.jpg"
              alt="Entertainment & Gaming Content Image"
              width={900}
              height={900}
      ...
      <section className="w-full flex justify-center mt-8 mb-8 px-2">
        <div className="w-full max-w-6xl bg-[#D9E9DD] rounded-[2.5rem] px-6 py-12 md:px-16 md:py-16 text-center">
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-sans">
            Contact us today and let's embark on a journey to elevate your brand's presence in the entertainment and gaming landscape.
          </p>
        </div>
      </section>
...
export default EntertainmentGamingPage;
