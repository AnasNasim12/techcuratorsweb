...
const DigitalMarketing = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await fetch('https://script.google.com/macros/s/AKfycbx5DQDJ_h8F6clbp-VvV_dGom3TDaTM5BvxvUxko2S2aA197j-TzMiOPm2e4arEq0g0yg/exec', {
                method: 'POST',
                mode: 'no-cors',
                cache: 'no-cache',
                headers: {
        ...
        <>
            ...
            <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
                <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-6 max-w-xl w-full md:mr-[-96px] z-10">
                    ...
                    <button
                        onClick={() => router.push('/contact')}
                        className="bg-green-800 hover:bg-green-900 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200"
                    >
                ...
                <div className='relative bg-[#429054]/20 mt-12 h-auto md:mt-22 flex justify-center items-center mx-auto py-4 md:py-4'>
                    <div className='max-w-screen-xl flex justify-center items-center mx-auto'>
                        <div className='flex items-center mx-auto scale-70'>
                            <Image src="/group 1.png" alt="data-driven digital marketing services" className='md:block hidden' width={400} height={400} priority />
                        </div>
            ...
            <section className="md:mt-22 mt-12">
                ...
                <div className="flex justify-center">
                    <button
                        onClick={() => router.push('/contact')}
                        className="bg-[#4B7D57] text-white px-8 py-3 rounded-md font-medium shadow hover:bg-green-700 transition"
                    >
            ...
            <section>
                <div className='relative py-16 mt-12 h-auto md:mt-22'>
                    <div className='max-w-screen-xl mx-auto px-4'>
                            ...
                            <div className="max-w-screen-lg mx-auto px-4 sm:px-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4">
                                    <div className="relative col-span-1 sm:col-span-2 rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry1dm.png)' }}
                                        role="img"
                                        aria-label="BFSI and Fintech Industry"
                                    >
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            ...
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                Our digital marketing services for the BFSI & Fintech sector help organizations with a complete online presence, lead generation, and campaigns for complying with legislation practices for financial institutions and fintech companies.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry2dm.png)' }}
                                        role="img"
                                        aria-label="Fashion and Lifestyle Industry"
                                    >
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            <span className="text-[#3c6446] font-bold sm:text-base block">Fashion & Lifestyle</span>
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                We deliver innovative digital marketing solutions for fashion and lifestyle brands that enhance online sales, social media engagement, and brand recognition across multiple digital platforms.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry3dm.png)' }}>
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            ...
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                Our digital marketing agency has supplied solutions for the automotive platform, ranging from lead generation to customer acquisition and digital visibility, to help dealers and service centers grow.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="relative rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry5dm.png)' }}>
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            ...
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                Our digital marketing company helps marketing and advertising agencies increase reach, connect with clients, and generate growth through optimized campaigns and client retention strategies.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative col-span-1 sm:col-span-2 rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry6dm.png)' }}>
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            ...
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                We develop specialized digital marketing services for education and EdTech organizations, converting student enrollments, brand recognition, and engagement through SEO, social media marketing, and paid campaigns.
                                            </p>
                                        </div>
                                    </div>
                                    <div className="relative col-span-1 sm:col-span-1 md:col-span-2 rounded-lg shadow-sm overflow-hidden bg-cover bg-center h-36 sm:h-40 md:h-64" style={{ backgroundImage: 'url(/industry8dm.png)' }}>
                                        <div className="absolute bottom-0 left-0 w-full bg-[#D9E9DD] py-1 sm:py-2 text-center px-2">
                                            ...
                                            <p className="text-[#6a6a6a] text-xs sm:text-xs mt-1 leading-snug">
                                                Entertainment and gaming companies can use our digital marketing services to find their audiences, engage loyal fans, and create conversions through engaging campaigns and impactful digital experiences.
                                            </p>
                                        </div>
                                    </div>
            ...
            <section>
                <div className='relative bg-[#429054]/20 mt-12 h-auto md:mt-22 flex justify-center items-center mx-auto py-4 md:py-4'>
                    <div className='max-w-screen-xl flex justify-center items-center mx-auto'>
                        <div className='flex items-center mx-auto scale-70'>
                            <Image src="/group 2.png" alt="BFSI and Fintech Industry" className='md:block hidden' width={700} height={700} priority />
                        </div>
                        <div className='flex-row justify-center items-center px-6 py-8 md:py-12'>
