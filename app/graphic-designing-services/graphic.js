    ...
    'UI/UX Design': {
      ...
      points: [
        ...
        },
        {
          ...
          description: 'Utilizing user research, behavior analysis, and testing to create designs that enhance usability and drive conversions.'
        },
        {
    ...
    <>
      ...
      <section className="w-full mb-5 bg-[#B3D3BB] h-[50vh] sm:h-[60vh] md:h-[75vh] lg:h-[90vh] flex items-center justify-center relative overflow-hidden rounded-[30px] mx-auto mt-6 max-w-[95%]">
        ...
        >
          ...
          >
            Graphic Design Services Professional Logo & Print Design Solutions
          </motion.h1>
          <div
      ...
      <section>
        ...
        <div className="w-full mb-5 md:mt-22 mt-8 bg-[#B3D3BB] min-h-[450px] sm:min-h-[500px] md:min-h-[550px] flex items-center justify-center relative overflow-hidden rounded-[20px] sm:rounded-[30px] mx-auto max-w-[95%]">
          <div className="max-w-7xl mx-auto w-full px-3 sm:px-4 py-6 sm:py-8 md:py-10">
            <div className="text-center mb-4 sm:mb-6 md:mb-8 min-h-[60px] sm:min-h-[70px] flex items-center justify-center">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 px-2">
            ...
            <div className="w-full overflow-visible h-full">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 sm:gap-5 md:gap-6">
                {currentContent.points.map((point, index) => (
                  ...
                  >
                    <h3 className="text-base sm:text-lg font-medium text-[#1B223C] mb-2 sm:mb-4 leading-tight">
                      {point.title}
                    </h3>
      ...
      <section className='max-w-screen-xl mx-auto mt-12 md:mt-22'>
        <div className='flex justify-center items-center'>     
          <div className='text-center flex-row'>
            ...
            <h2 className='md:text-3xl text-xl text-black font-medium mt-4'>
            ...
            <p className='text-sm text-[#6a6a6a] mt-4 leading-[25px] max-w-screen-lg mx-auto px-4'>
              As a premier Graphic Designing Agency, Transcurators offers a full suite of graphics designing services that elevate your visual identity.
            </p>
          </div>
        </div>
