      ...
      <header className="fixed top-0 left-0 right-0 bg-white z-50 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-4 py-4">
          ...
          <div
            ...
            className="inline-block bg-green-600 text-white px-6 py-2 rounded-lg text-sm font-medium hover:bg-green-700"
          >
            Talk to Sales
          </div>
        ...
        <div className="flex justify-center items-center gap-4 mt-10">
          ...
          {Array.from({ length: totalProjectPages }).map((_, idx) => (
            <button
              ...
              className={`w-20 h-2 rounded ${currentProjectPage === idx + 1
