...
const features = [
  {
    ...
    description: "We understand financial regulations, trends in the market, and technology development.",
    image: "/bfsiexpertise.jpg",
    alt: "Industry Expertise",
  },
  {
    title: "SEO Optimization",
    description: "Creating content to rank and create organic traffic and visibility.",
    image: "/seooptbfsi.jpg",
    alt: "SEO Optimization",
  },
  {
    title: "Compliance and Accuracy",
    description: "All content needs to be compliant and factually correct.",
    image: "/compliancevfsi.jpg",
    alt: "Compliance and Accuracy",
  },
];
  // Add counter state
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:justify-center border-4 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[25vh] md:h-[45vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full mt-4 py-8 md:py-4 relative overflow-visible">
          ...
          >
            ...
            >
              BFSI & Fintech Content That Builds <span className='text-[#4B7D57]'><br/>Trust and Drives Engagement</span>
            </motion.h1>    
          </motion.div>
      ...
      <div className="flex justify-center md:mt-22 mt-12 px-4 md:px-6">
        <p className="text-center max-w-4xl mx-auto text-[#6a6a6a]">In the fast-moving field of Banking, Financial Services, and Insurance (BFSI) and Fintech, it is essential to provide clear, precise, and entertaining content every time. At TransCurators, we will provide content that will keep your audience engaged and build trust.</p>
      </div>
        ...
        <div className="max-w-screen-xl flex justify-center mx-auto items-center">
          <div className="text-center flex-row">
            <p className="md:text-3xl text-xl text-black font-medium mt-4">
              ...
              <span className="text-[#326B3F]"><br/>BFSI & Fintech Content?</span>
            </p>
            <p className="text-sm text-[#6a6a6a] mt-4 ">
              With a team of 200+ writers specialising in financial services, we know financial services and packaging horizontally within sectors.<br/> Our content strategies cover: 
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 w-[45vw] h-[45vw] md:w-[32vw] md:h-[32vw] lg:w-[29vw] lg:h-[29vw] rounded-[50%] bg-[#7db88b]/60 -translate-y-[40%]"></div>
            ...
            <div className="flex flex-col md:flex-row border-2 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[50vh] md:h-[90vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full md:mt-22 mt-12 py-8 md:py-4 relative overflow-hidden">
              ...
              >
                ...
                >
                  With numerous clients we've worked with, from traditional banks to innovative fintech companies, we've refined our craft of developing engaging content. Our products are:
                </motion.h2>
  ...
  {
    number: 1,
    title: "Financial Reports & Whitepapers",
    description: "Offering in-depth analysis and market trend insights."
  },
  {
    number: 2,
    title: "Product Descriptions",
    description: "Focusing on benefits and key characteristics of financial products and services."
  },
  {
    number: 3,
    title: "Educational Blogs & Articles",
    description: "Bringing complex financial concepts to the masses."
  },
  {
    number: 4,
    title: "Social Media Campaigns",
    description: "Creating engaging posts that build community and brand affinity."
  },
  {
    number: 5,
    title: "Email Marketing",
    description: "Building newsletters that educate, engage, and convert."
  }
].map((item, index) => (
                    <motion.div
                      key={item.number}
              ...
              <div className="relative bg-[#D9E9DD] w-full">
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
                  ...
                  <p className="text-[#6a6a6a] text-sm md:text-base text-center px-2 md:px-4 max-w-4xl mx-auto leading-relaxed mb-8">
                    Whether you must introduce a new financial product, try to inform your customers, or attempt to build credibility for your brand, our content strategies are designed to meet your particular goals. We specialize in:
                  </p>
                  <div className="flex flex-col md:flex-row justify-center items-stretch gap-4 md:gap-6 max-w-5xl mx-auto">
                    {[
                      {
                        title: "Getting to Know Your Brand Voice",
                        description: "Consistency across all channels of content."
                      },
                      {
                        title: "Aligning to Your Marketing Goals",
                        description: "Developing content aligned with your final marketing objective."
                      },
                      {
                        title: "Driving Engagement",
                        description: "Developing content that draws and engages your audience."
                      }
                    ].map((step, idx) => (
                      <div
                        key={idx}
      ...
      <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
        ...
        <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-12 max-w-xl w-full md:mr-[-96px] z-10">
          <h2 className="text-2xl md:text-3xl mb-4">
            Let's Elevate Your<span className='text-[#326B3F]'><br/>Financial Content Together</span>
          </h2>
          <p className="text-[#6a6a6a] mb-4">
In BFSI and Fintech's fast-paced competitive environment, your narrative can be your point of differentiation. At TransCurators, we're here to collaborate with you to craft stories that educate and motivate you.</p>
        </div>
  ...
  <div className="w-full max-w-6xl bg-[#D9E9DD] rounded-[2.5rem] px-6 py-12 md:px-16 md:py-16 text-center">
    <h2 className="text-2xl md:text-3xl font-medium mb-6 font-sans">
      Ready to transform your <span className="text-[#326B3F]">financial content strategy?</span>
    </h2>
    <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-sans">
      Reach out to us today, and let us start a journey to enhance your brand's visibility in the BFSI and Fintech space.
    </p>
  </div>
</section>
...
export default BFSIFintechPage;
