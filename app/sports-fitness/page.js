...
const SportsFitnessPage = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex flex-col md:justify-center border-4 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[25vh] md:h-[45vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full mt-4 py-8 md:py-4 relative overflow-visible">
          ...
          >
            ...
            >
              Sports & Fitness Content <span className='text-[#4B7D57]'><br/>That Inspires Action</span>
            </motion.h1>    
          </motion.div>
      ...
      <div className="flex justify-center md:mt-22 mt-12 px-4 md:px-6">
        <p className="text-center max-w-4xl mx-auto text-[#6a6a6a]">When it comes to the fast-paced world of sports and fitness, where motivation fuses purpose with movement, it is important to deliver engaging and energising content. At TransCurators, we are focused on creating compelling content that resonates with enthusiasts, athletes, and wellbeing seekers alike.</p>
      </div>
        ...
        <div className="max-w-screen-xl flex justify-center mx-auto items-center">
          <div className="text-center flex-row">
            <p className="md:text-3xl text-xl text-black font-medium mt-4">
              ...
              <span className="text-[#326B3F]"><br/>Sports & Fitness Content?</span>
            </p>
            <p className="text-sm text-[#6a6a6a] mt-4 ">
              With over 200+ dedicated writers, we understand the sports and fitness space. Our goal is to not only inform but also to inspire and enable your audience to progress towards their goals while staying true to your brand.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="absolute top-0 w-[45vw] h-[45vw] md:w-[32vw] md:h-[32vw] lg:w-[29vw] lg:h-[29vw] rounded-[50%] bg-[#7db88b]/60 -translate-y-[40%]"></div>
            ...
            <div className="flex flex-col md:flex-row border-2 border-[#429450] md:rounded-4xl min-h-fit md:min-h-[50vh] md:h-[90vh] md:max-w-[calc(100vw-40px)] lg:max-w-[calc(100vw-70px)] w-full md:mt-22 mt-12 py-8 md:py-4 relative overflow-hidden">
              ...
              >
                ...
                >
                  After writing for a diverse clientele from local fitness startup businesses to established sports brands, we have consciously tried to not only build but refine our craft, ultimately setting ourselves apart from others because of that experience. Our services include:
                </motion.h2>
                  ...
                  {[
  {
    ...
    description: "Cover the full spectrum of content from workout routines to nutrition tips and everything in between, all while establishing your brand as a leader in search rank."
  },
  {
    number: 2,
    title: "Social Media Posts",
    description: "Aiming to foster community and engagement through great posts that will get them talking."
  },
  {
    number: 3,
    title: "Product Descriptions",
    description: "Clearly articulate what is great about your fitness gear or supplement benefits based on features."
  },
  {
    number: 4,
    title: "Video Scripts",
    description: "Create stories for either promotional or how-to videos that capture the spirit of your video product."
  },
  {
    number: 5,
    title: "Email Campaigns",
    description: "Newsletters that entice your audience with relevant and engaging content."
  }
].map((item, index) => (
                    <motion.div
                      key={item.number}
          ...
          <section id="metrics-section" className="md:mt-22 mt-12 bg-white">
              <div className="max-w-screen-xl mx-auto px-4">
                  <div className="text-center mb-8 md:mb-16">
                      ...
                      <p className="text-[#6a6a6a] mt-4 text-sm">Our commitment to quality and consistency has led to:</p>
                  </div>
              ...
              <div className="relative bg-[#D9E9DD] w-full">
                <div className="max-w-7xl mx-auto px-4 py-12 md:py-16">
                  <h2 className="text-xl md:text-2xl lg:text-3xl text-center mb-6 md:mb-10">
                    Tailored Solutions for <span className="text-[#3c6446] font-normal">Every Need</span>
                  </h2>
                  <p className="text-[#6a6a6a] text-sm md:text-base text-center px-2 md:px-4 max-w-4xl mx-auto leading-relaxed mb-8">
                    If you are promoting a new fitness app, a sporting event, or athletic wear, our content strategies are designed to suit your specific needs:
                  </p>
                    ...
                    {[
                      {
                        ...
                        description: "Discovering the deep interests of your target demographic target market."
                      },
                      {
                        title: "Consistent Brand Voice",
                        description: "Making sure our content is consistent in all areas of content."
                      },
                      {
                        title: "Engagement",
                        description: "Creating material that has both pulling power and keeps people coming back."
                      }
                    ].map((step, idx) => (
                      <div
                        key={idx}
      ...
      <section className="flex flex-col md:flex-row items-center justify-center min-h-[auto] md:min-h-screen bg-white px-4 py-12">
        ...
        <div className="bg-white rounded-xl md:rounded-tr-2xl md:rounded-br-2xl shadow-lg p-12 max-w-xl w-full md:mr-[-96px] z-10">
          ...
          <p className="text-[#6a6a6a] mb-4">
            In sports and fitness, content can set you apart from your competition. We at TransCurators are excited to partner with you to deliver invaluable content narratives that always light up a conversation.
          </p>
        </div>
        ...
        <div className="hidden md:flex mt-8 md:mt-0 md:ml-[-64px] flex-1 items-center justify-center">
          <div className="rounded-2xl overflow-hidden w-[859px] h-[476px] flex items-center justify-center shadow-lg">
            <Image
              src="/sportsfitness.jpg"
              alt="Sports & Fitness Content Image"
              width={900}
              height={900}
      ...
      <section className="w-full flex justify-center mt-8 mb-8 px-2">
        <div className="w-full max-w-6xl bg-[#D9E9DD] rounded-[2.5rem] px-6 py-12 md:px-16 md:py-16 text-center">
          <h2 className="text-2xl md:text-3xl font-medium mb-6 font-sans">
            Ready to energize your <span className="text-[#326B3F]">content strategy?</span>
          </h2>
          <p className="text-gray-600 text-sm md:text-base leading-relaxed max-w-4xl mx-auto font-sans">
            Contact us today and let's embark on a journey to elevate your brand's presence in the sports and fitness world.
          </p>
        </div>
      </section>
